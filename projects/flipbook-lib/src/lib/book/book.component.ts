    ...
    if (this.model && pages.length > 1) {
      ...
      while (pages.length > 1) {
        ...
        this.pages.push({
          ...
          front: {
            ...
            isComponent: frontPage.isComponent,
            component: frontPage.component,
          },
          back: {
            ...
            isComponent: backPage.isComponent,
            component: backPage.component,
          },
          rotation: 0
        });
      }
      ...
      if (!hasCover && this.model.endPageType === PageType.Single) {
        ...
        if (this.model.startPageType !== PageType.Single && pages.length) {
          ...
          backCover.front.isComponent = lastPage.isComponent;
          backCover.front.component = lastPage.component;
        }
